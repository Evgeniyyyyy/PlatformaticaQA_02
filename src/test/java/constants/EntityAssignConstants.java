...
public class EntityAssignConstants {
    ...
    public static final By LINK_ASSIGN_ENTITY = By.xpath("//p[text()=' Assign ']");
    ...
    public static final By ASSIGN_DATETIME_FIELD = By.id("datetime");
    ...
    public static final By ASSIGN_GET_CONTANER = By.className("card-body");
