...
public class EntityBoardDraftRecordTest extends BaseTest {
    ...
    private BoardEditPage fillFormNewRecord(List<String> list) {
    ...
    public void testCreateDraftRecord() {
        ...
        boardEditPage = fillFormNewRecord(EXPECTED_CREATED_PENDING_RECORD);
    ...
    public void testSortDraftRecords() {
        ...
        List<String> expectedSortedRecords = ALL_RECORDS_TABLE
                .stream()
        ...
        boardEditPage = fillFormNewRecord(EXPECTED_CREATED_PENDING_RECORD);
        boardEditPage.clickSaveDraft();
        boardEditPage = fillFormNewRecord(EXPECTED_CREATED_ONTRACK_RECORD);
        boardEditPage.clickSaveDraft();
